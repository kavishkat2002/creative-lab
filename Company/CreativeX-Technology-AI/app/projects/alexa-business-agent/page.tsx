  ...
  return (
    <main id="top" className="site-shell case-study-page">
      ...
      <div id="case-study-content">
        ...
        <section className="case-study-capabilities"><div className="site-width case-study-capabilities-grid"><p className="section-index">Designed capabilities / 04</p><div>{[...project.capabilities, ...project.outcomes].map((item, index) => <div key={item}><span>0{index + 1}</span><Check /><strong>{item}</strong></div>)}</div></div></section>
